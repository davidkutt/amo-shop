...
export const GET_COLLECTION_INFO_BY_HANDLE_QUERY = gql`
  query getCollectionInfoByHandle($handle: String!) {
...
// ... keep your other queries ...

export const GET_PRODUCTS_BY_COLLECTION_HANDLE_QUERY = gql`
  query getProductsByCollectionHandle($handle: String!, $first: Int!) {
    collection(handle: $handle) {
      title
